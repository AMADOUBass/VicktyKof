...
const values = [
  {
    icon: Award,
    title: "Excellence",
    description: "15+ ans d'expertise en locs et coiffures afro.",
  },
  {
    icon: Heart,
    title: "Passion",
    description: "Chaque cliente reçoit une attention personnalisée.",
  },
  {
    icon: Shield,
    title: "Qualité",
    description: "Produits naturels et techniques douces certifiées.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          <h2 className="section-title mb-6">
            Rencontrez <span className="text-brand-gold italic">Vicky</span>,
            <br />
            Maître Loctician & Fondatrice de VicktyKof
          </h2>
          <div className="divider-gold mx-0 mb-6 w-16" />
          <p className="text-brand-muted leading-relaxed mb-4">
            Passionnée par la beauté naturelle africaine depuis plus de 15 ans,
            Vicky a fondé VicktyKof avec une vision claire : offrir à chaque
            cliente un espace où son identité et sa beauté sont célébrées.
          </p>
          <p className="text-brand-muted leading-relaxed mb-8">
            Spécialisée dans les locs, interlocks et coiffures afro, elle forme
            également une équipe d&apos;expertes partageant sa passion pour
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {values.map((v) => {
              ...
              return (
                <div
                  key={v.title}
                  className="text-center p-4 bg-brand-black/40 rounded-xl border border-white/5">
